...
![StateTree Overview](https://dev.epicgames.com/community/api/documentation/image/e1c0c165-c8fe-4ca2-8202-1ae921eb17d1?resizing_type=fill&width=1920&height=335)
...
[![undefined](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/af7af0ae-d238-45b6-8aa4-639da23eb006/st-overview-1.png)](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/af7af0ae-d238-45b6-8aa4-639da23eb006/st-overview-1.png)
...
StateTree nodes can share data among themselves. The different elements in the StateTree can bind to data in the following manner (see [[System design/documentation#State Tree Integration|VR Weapon implementation]] for a real-world example):
